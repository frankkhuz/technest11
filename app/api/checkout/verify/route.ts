...
function serialize(doc: Record<string, unknown>): Order {
  return {
    ...
    sellerId: doc.sellerId as string | undefined,
    sellerAmount: doc.sellerAmount as number | undefined,
    platformFee: doc.platformFee as number | undefined,
    subaccountCode: doc.subaccountCode as string | undefined,
